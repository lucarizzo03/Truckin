...
systemPrompt = `You are a helpful AI assistant that processes user messages and can call various tools to help users. You have access to trucking-related functionality through the MCP server.`
